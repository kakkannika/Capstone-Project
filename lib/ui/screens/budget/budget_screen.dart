                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: "Total Budget ${currencySymbol != '' ? '($currencySymbol)' : ''}",
                                    ...
                                    border: OutlineInputBorder(
                                      ...
                                      borderSide: BorderSide(color: DertamColors.greyLight,width: 2),
                                    ),
                                    ...
                                    suffixIcon: Padding(
                                      ...
                                      child: DropdownButtonHideUnderline(
                                        child: DropdownButton<String>(
                                          ...
                                          icon: Icon(Icons.arrow_drop_down, color: DertamColors.grey),
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: TextButton.icon(
                                        icon: Icon(
                                          Icons.refresh,
                                          color: DertamColors.primary, // Matching turquoise color
                                          size: 18,
                                        ),
                                        label: Text(
