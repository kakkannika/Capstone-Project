    ...
    await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AddExpenseScreen(
          selectedCurrency: budget.currency,
          remainingBudget: budget.remaining +
              expense.amount, // Add back this expense's amount
          budgetId: budget.id,
          tripId: widget.tripId,
              ...
              Provider.of<BudgetProvider>(context, listen: false)
                ...
                if (!success) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content:
                          Text('Failed to remove expense. Please try again.'),
  ...
  Widget _buildFilterButton(String value, String label) {
    ...
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor:
            isSelected ? DertamColors.primary : DertamColors.greyLight,
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.history_toggle_off,
                                size: 64, color: DertamColors.grey),
                            const SizedBox(height: 16),
                            Text(
                              "No past expenses found",
                              style: TextStyle(
                                  color: DertamColors.grey, fontSize: 16),
                            ),
                          ],
                        ),
                      ),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Divider(
                                  thickness: 1, color: DertamColors.greyLight),
                            ],
                          );
                        },
                      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<Budget?>(
        stream: Provider.of<BudgetProvider>(context)
            .getBudgetByTripIdStream(widget.tripId),
        builder: (context, snapshot) {
          ...
          print(
              "Budget in UI: Total=${budget.total}, Daily=${budget.dailyBudget}, Spent=${budget.spentTotal}");
          ...
          if (dailyBudget <= 0 && totalBudgetValue > 0) {
            ...
            if (_trip != null && _trip!.days.isNotEmpty) {
              dailyBudget = budgetProvider.calculateDailyBudget(
                  totalBudgetValue, _trip!.days.length);
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.search_off,
                                size: 48, color: DertamColors.grey),
                            SizedBox(height: 16),
                            Text(
                              "No expenses found",
                              style: TextStyle(
